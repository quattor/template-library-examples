...
# url = http://quattor.web.lal.in2p3.fr/yum/snapshots/emi_3_thirdparty_sl5_x86_64
#
...
"protocols" = list(
  nlist("name","http",
        "url","http://"+YUM_SNAPSHOT_URL+"/yum/snapshots/"+YUM_SNAPSHOT_DATE+"/emi_3_thirdparty_sl5_x86_64")
);
